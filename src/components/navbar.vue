...
const toggleDarkMode = () => {
  ...
  console.log('Modo oscuro:', isDarkMode.value)
}
</script>
...
<template>
  ...
  <div class="flex items-center gap-6">
    <button @click="layout.toggleSidebar" class="p-2 rounded-lg hover:bg-gray-100 text-[#3f2a52]">
  ...
  <div class="flex items-center gap-6">
    <button class="bg-[#3f2a52] hover:bg-[#beaed8] text-white text-xs font-bold py-2 px-4 rounded-md transition-all whitespace-nowrap">
