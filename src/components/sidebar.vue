<template>
  ...
  <ul class="flex flex-col gap-1">
    ...
    <li>
      <RouterLink to="/captura" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-slate-200 hover:bg-[#beaed8] hover:text-[#3f2a52] transition-colors font-medium">
