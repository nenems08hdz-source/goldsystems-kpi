...
<template>
  ...
  >
    <template #default="{ fila }">
      ...
      <td class="p-4 text-gray-600 text-sm group-hover:bg-[#beaed8] transition-colors duration-150 cursor-pointer">{{ fila.departamento }}</td>
      <td class="p-4 text-gray-600 text-sm group-hover:bg-[#beaed8] transition-colors duration-150 cursor-pointer">{{ fila.responsable }}</td>
      <td class="p-4 font-semibold text-gray-800 text-sm group-hover:bg-[#beaed8] transition-colors duration-150 cursor-pointer">{{ fila.valor }}</td>
